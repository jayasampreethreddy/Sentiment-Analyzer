...
data=load_dataset(r'C:\Users\konde\Music\projects\sentimentanalysis\data\IMDB-Dataset.csv')
...
joblib.dump(text_clf, r'C:\Users\konde\Music\projects\sentimentanalysis\models\model\classifier.pkl',compress=True)
